...
var CardRotateAnimation = function (_Component) {
  ...
  function CardRotateAnimation(props) {
    ...
    _this.getFrontContent = function () {
      ...
      return React.createElement('img', { src: imgFrontSrc, alt: imgFrontAlt });
    };
    ...
    _this.getBackContent = function () {
      ...
      return React.createElement('img', { src: imgBackSrc, alt: imgBackAlt });
    };
...
export default CardRotateAnimation;
